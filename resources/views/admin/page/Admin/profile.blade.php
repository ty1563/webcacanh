                ...
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted font-size-sm">@{{ info.is_master ? "Master" : "Admin"}}</p>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" class="form-control" :value="info.ho_ten">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" class="form-control" :value="info.sdt">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary text-end">
                            <input type="button" class="btn btn-primary px-4" value="Lưu Cập Nhật">
                        </div>
                    </div>
                </div>
            </div>
